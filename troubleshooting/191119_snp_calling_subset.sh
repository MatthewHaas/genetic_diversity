...
#PBS -e 191119_snp_calling_subset.err
#PBS -o 191119_snp_calling_subset.out
#PBS -N 191119_snp_calling_subset
...
bams='present_natural_stands_only.txt'
prefix="191119_samtools"
