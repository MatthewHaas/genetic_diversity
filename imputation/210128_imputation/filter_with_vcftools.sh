...
~/vcftools/bin/vcftools --gzvcf  $i --keep samples_to_keep_for_ref_panel_fewer_than_200_missing.txt --min-alleles 2 --max-alleles 2 --maf 0.05 --remove-indels --minDP 6 --recode --recode-INFO-all --out filtered_vcf_files/${STEM}_filtered
done
