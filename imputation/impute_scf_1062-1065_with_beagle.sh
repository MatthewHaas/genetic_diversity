...
#PBS -e impute_scf_1062-1065_with_beagle.err
#PBS -o impute_scf_1062-1065_with_beagle.out
#PBS -N impute_scf_1062-1065_with_beagle
...
for i in $(cat Scaffolds_1062-1065.txt)
do
