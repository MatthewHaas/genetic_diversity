...
~/vcftools/bin/vcftools --gzvcf seventeen_largest_vcfs_merged.vcf.gz --maf 0.05 --max-missing 0.50 --recode
mv out.recode.vcf largest_scaffolds_max_missing_half.vcf
