...
#SBATCH -o filter_vcfs_20NA.out
#SBATCH -e filter_vcfs_20NA.err
...
~/vcftools/bin/vcftools --gzvcf  $i --max-missing 0.80 --min-alleles 2 --max-alleles 2 --maf 0.01 --remove-indels --minDP 4 --recode --recode-INFO-all --out ${STEM}_filtered_20_NA
done
