...
write.csv(a, file="191126_full_set_main_gbs_snps_filtered.csv", row.names=FALSE, col.names=TRUE)
# Save data (especially the most important ones--so I can retrieve lower depth--5 to 9 reads-- if necessary)
save(a, y, scaffolds_of_interest, file="191126_full_set_main_gbs_snps_filtered.Rdata")
