...
~/vcftools/bin/vcftools --gzvcf filt_20_NA_vcf_files_concat_short_sample_names.vcf --keep breeding_lines_for_vcftools_filt.txt --recode --recode-INFO-all --out breeding_lines
