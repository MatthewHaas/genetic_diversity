...
~/vcftools/bin/vcftools --gzvcf filt_20_NA_concat_with_IDs_dp4_short_sample_names.vcf --keep temporal_samples_for_vcftools_filt.txt --recode --recode-INFO-all --out temporal_samples_dp4
