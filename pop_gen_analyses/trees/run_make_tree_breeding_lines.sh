...
#SBATCH -o run_make_tree_breeding_lines.out
#SBATCH -e run_make_tree_breeding_lines.err
...
Rscript make_tree_breeding_lines.R breeding_lines.recode.vcf breeding_lines.csv breeding_lines_tree.Rdata breeding_lines_tree.pdf
