...
bcftools concat '190627_samtools_Scaffold_48;HRSCAF=1451.vcf.gz' '190627_samtools_Scaffold_70;HRSCAF=1591.vcf.gz' > merged_file.vcf.gz
...
x <- read.vcfR("merged_file.vcf.gz")
...
pca <- glPca(gen_light_x, nf=8, n.cores=2)
